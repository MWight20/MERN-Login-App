...
- Find a way for page to reload automatically on signin and logout:
  navbar doesn't load "home","content", and "logout" without manual refresh
  user table won't load automatically after sign-up (switch to form?)
...
- Add method to prevent all users from being deleted
- Add login Hint
...
```
 6/22/2018 :
 - Added a users table
 - Added GET method to query all user names and emails
